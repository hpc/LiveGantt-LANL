...
FIELDS="jobidraw%9,jobid,priority,qos,partition,nnodes%6,ntasks,submit%24,eligible%24,start%24,end%24,timelimit%24,state,reservation,nodelist,flags%36,submitline,account,user,consumedenergy,consumedenergyraw,batchflag,"
ARGS="-a -X -p"
